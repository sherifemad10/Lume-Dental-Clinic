...
const BookAppointmentCard = () => {
  return (
    <div className="bg-dental-blue rounded-2xl p-7 shadow-lg">
      <div className="flex flex-col md:flex-row items-center">
        <div className="md:w-1/2">
          <h3 className="text-2xl font-semibold mb-2">Book Your Appointment</h3>
          <p className="mb-4">In Minutes</p>
          <p className="mb-6 text-sm">Want a brighter smile? Schedule your visit today!</p>
